    ...
    <View style={styles.root}>
      ...
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.floatingArea}>
          <EditorialPressable style={styles.newButton} onPress={() => setShowCreate(true)} pressShadow="1px 1px 0 0 #2D3436">
        ...
        <View style={styles.whiteCard}>
          ...
          {loading ? (
            ...
            <View style={styles.emptyCard}>
              ...
              <EditorialPressable style={styles.createButton} onPress={() => setShowCreate(true)} pressShadow="1px 1px 0 0 #2D3436">
              ...
              return (
                <Pressable key={s.id} onPress={() => resume(s)} style={styles.sessionCard}>
                  ...
                  <View style={styles.resumeRow}>
                    <Text style={[styles.resumeText, { color: subjectColor }]}>Resume â†’</Text>
                  </View>
                </Pressable>
              );
            })
        ...
        <View style={{ height: 100, backgroundColor: '#FDFBF7' }} />
      </ScrollView>
...
const makeStyles = (_theme: GlassTheme) => StyleSheet.create({
  ...
  greeting: { fontSize: 29, fontWeight: '700', color: '#2D3436', lineHeight: 35, fontFamily: SERIF, letterSpacing: 0.2 },
  ...
  newButton: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: GREEN, paddingHorizontal: 16, height: 40, borderWidth: 2, borderColor: '#2D3436', borderRadius: 255, borderTopLeftRadius: 255, borderTopRightRadius: 15, borderBottomLeftRadius: 225, borderBottomRightRadius: 15, boxShadow: '3px 3px 0 0 #2D3436' },
  newButtonText: { color: '#FDFBF7', fontFamily: SERIF, fontWeight: '700', fontSize: 15, letterSpacing: 0.3 },

  whiteCard: { backgroundColor: '#FDFBF7', borderTopLeftRadius: 22, borderTopRightRadius: 7, paddingHorizontal: 24, paddingTop: 24, paddingBottom: 24, marginTop: 64, borderColor: '#2D3436', borderWidth: 2, boxShadow: '4px 4px 0 0 #2D3436' },

  statsGrid: { flexDirection: 'row', gap: 10 },
  statCard: { flex: 1, backgroundColor: '#FDFBF7', borderRadius: 20, borderTopLeftRadius: 20, borderTopRightRadius: 8, borderBottomLeftRadius: 22, borderBottomRightRadius: 7, borderWidth: 2, borderColor: '#2D3436', padding: 14, boxShadow: '3px 3px 0 0 #2D3436' },
  ...
  sessionsTitle: { fontFamily: SERIF, fontSize: 18, fontWeight: '700', color: '#2D3436' },
  calendarLink: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  calendarLinkText: { fontFamily: SERIF, fontSize: 13, fontWeight: '700', color: GREEN },

  tabs: { flexDirection: 'row', gap: 8, marginBottom: 20 },
  tab: { height: 36, paddingHorizontal: 24, borderRadius: 18, alignItems: 'center', justifyContent: 'center' },
  tabActive: { backgroundColor: '#EFEAE0', borderWidth: 2, borderColor: '#2D3436', borderRadius: 255, borderTopLeftRadius: 255, borderTopRightRadius: 15, borderBottomLeftRadius: 225, borderBottomRightRadius: 15, boxShadow: '2px 2px 0 0 #2D3436' },
  tabText: { fontFamily: SERIF, fontSize: 14, fontWeight: '500', color: '#555E61' },
  tabTextActive: { fontFamily: SERIF, fontSize: 14, fontWeight: '700', color: '#2D3436' },

  emptyCard: { backgroundColor: '#FDFBF7', borderRadius: 20, borderTopLeftRadius: 20, borderTopRightRadius: 8, borderBottomLeftRadius: 22, borderBottomRightRadius: 7, borderWidth: 2, borderColor: '#2D3436', padding: 32, alignItems: 'center', boxShadow: '3px 3px 0 0 #2D3436' },
  ...
  emptyTitle: { fontFamily: SERIF, fontSize: 18, fontWeight: '700', color: '#2D3436', marginBottom: 8 },
  emptyDesc: { fontFamily: SERIF, fontSize: 14, color: '#555E61', textAlign: 'center', lineHeight: 20, opacity: 0.8, marginBottom: 32, maxWidth: 260 },
  createButton: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: GREEN, width: '100%', height: 58, borderWidth: 2, borderColor: '#2D3436', borderRadius: 255, borderTopLeftRadius: 255, borderTopRightRadius: 15, borderBottomLeftRadius: 225, borderBottomRightRadius: 15, justifyContent: 'center', boxShadow: '3px 3px 0 0 #2D3436' },
  createButtonText: { color: '#FDFBF7', fontFamily: SERIF, fontWeight: '700', fontSize: 16, letterSpacing: 0.3 },
  arrowIndicator: { position: 'absolute', bottom: 80, right: -4, transform: [{ rotate: '15deg' }], opacity: 0.4 },

  sessionCard: { backgroundColor: '#FDFBF7', borderRadius: 20, borderTopLeftRadius: 20, borderTopRightRadius: 8, borderBottomLeftRadius: 22, borderBottomRightRadius: 7, borderWidth: 2, borderColor: '#2D3436', padding: 16, marginBottom: 12, boxShadow: '3px 3px 0 0 #2D3436' },
  ...
  sessionTitle: { fontFamily: SERIF, fontSize: 14, fontWeight: '700', color: '#2D3436', marginBottom: 2 },
  sessionTime: { fontFamily: SERIF, fontSize: 11, color: '#555E61', marginBottom: 10 },
  progressRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  progressLabel: { fontFamily: SERIF, fontSize: 10, fontWeight: '600', color: '#555E61', textTransform: 'uppercase', letterSpacing: 1.2 },
  progressValue: { fontFamily: SERIF, fontSize: 10, fontWeight: '700', color: '#2D3436' },
  track: { height: 6, borderRadius: 3, backgroundColor: '#EFEAE0', overflow: 'hidden' },
  trackFill: { height: '100%', borderRadius: 3 },
  resumeRow: { flexDirection: 'row', justifyContent: 'flex-end', marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#EFEAE0' },
  resumeText: { fontFamily: SERIF, fontSize: 9, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, opacity: 0.6 },
