...
import { Stamp, Kicker, SERIF, EditorialPressable } from '@/components/editorial';
import {
  AlertCircle,
  Check,
  ChevronRight,
        ...
        >
          ...
          <View style={styles.emptyCard}>
            <View style={styles.emptyIcon}>
              <Icon icon={Trophy} size={28} color="#8A8478" />
            </View>
        ...
        >
          ...
          <View style={styles.takeHeader}>
            ...
            <Pressable onPress={exitQuiz} accessibilityRole="button" style={styles.exitBtn} hitSlop={8}>
              <Icon icon={X} size={13} color="#555E61" strokeWidth={2.5} />
    ...
    return (
      <View style={styles.root}>
        ...
        >
          ...
          <EditorialPressable onPress={exitQuiz} accessibilityRole="button" style={styles.primaryBtn} pressShadow="1px 1px 0 0 #2D3436">
            <Icon icon={Trophy} size={15} color="#FDFBF7" strokeWidth={2.2} />
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.listHeader}>
          <View style={{ flex: 1 }}>
            <Kicker style={{ marginBottom: 6, marginLeft: 2 }}>Test yourself</Kicker>
            <Text style={styles.pageTitle}>Quizzes</Text>
          </View>
          <EditorialPressable
            accessibilityRole="button"
          ...
          >
            {!generating ? <Icon icon={RefreshCw} size={14} color="#FDFBF7" strokeWidth={2.2} /> : null}
            ...
            return (
              <Pressable key={q.id} accessibilityRole="button" onPress={() => startQuiz(q)} style={styles.card}>
                <View style={styles.quizTop}>
                  ...
                  {q.completed ? (
                    <Stamp tone="forest" rotate={pct >= 70 ? -2 : 2}>{pct}%</Stamp>
                  ) : null}
                </View>
                <Text style={styles.quizMeta}>
                  {q.questions.length} questions Â· {q.completed ? 'Completed' : 'Not taken'}
                </Text>
                <View style={styles.quizAction}>
                  ...
                  <Icon icon={ChevronRight} size={13} color="#8A8478" strokeWidth={2.2} />
                </View>
              </Pressable>
            );
          })
...
const styles = StyleSheet.create({
  ...
  overline: { fontSize: 10, fontWeight: '700', color: GREEN, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2, fontFamily: SERIF },
  pageTitle: { fontSize: 30, fontWeight: '700', color: '#2D3436', fontFamily: SERIF, letterSpacing: 0.2 },
  ...
  generateBtnText: { fontSize: 11, fontWeight: '700', color: '#FDFBF7', letterSpacing: 0.5, fontFamily: SERIF },
  ...
  moduleChipActive: { backgroundColor: '#3F5C3A' },
  moduleChipLabel: { fontFamily: SERIF, fontSize: 12, fontWeight: '600', color: '#3F5C3A', letterSpacing: 0.3, textTransform: 'uppercase' },
  moduleChipLabelActive: { color: '#FDFBF7' },

  errorCard: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  errorText: { flex: 1, fontSize: 13, lineHeight: 18, color: RED, fontWeight: '600', fontFamily: SERIF },

  quizTop: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 },
  quizTitle: { flex: 1, fontSize: 15, fontWeight: '700', color: '#2D3436', lineHeight: 21, fontFamily: SERIF },
  scoreBadge: { borderRadius: 12, paddingHorizontal: 10, paddingVertical: 4 },
  scoreBadgeText: { fontSize: 11, fontWeight: '700' },
  quizMeta: { fontSize: 12, color: '#8A8478', marginTop: 4, fontFamily: SERIF },
  quizAction: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 12 },
  quizActionText: { fontSize: 10, fontWeight: '700', color: GREEN, letterSpacing: 0.5, fontFamily: SERIF },

  takeHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 20 },
  takeTitle: { flex: 1, fontSize: 22, fontWeight: '700', color: '#2D3436', fontFamily: SERIF },
  exitBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  exitBtnText: { fontSize: 10, fontWeight: '700', color: '#555E61', letterSpacing: 0.5, fontFamily: SERIF },

  progressRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 20 },
  progressTrack: { flex: 1, height: 6, borderRadius: 3, backgroundColor: '#EFEAE0', overflow: 'hidden' },
  progressFill: { height: '100%', borderRadius: 3, backgroundColor: GREEN },
  progressCount: { fontSize: 12, fontWeight: '700', color: '#555E61', fontFamily: SERIF },

  questionOverline: { fontSize: 10, fontWeight: '700', color: GREEN, textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 8, fontFamily: SERIF },
  questionText: { fontSize: 18, fontWeight: '600', color: '#2D3436', lineHeight: 26, fontFamily: SERIF },
  ...
  answerSelected: { borderWidth: 2, borderColor: GREEN, backgroundColor: GREEN },
  answerLetter: {
    width: 30,
    height: 30,
    borderRadius: 15,
  ...
  answerLetterSelected: { backgroundColor: '#FDFBF7' },
  answerLetterText: { fontSize: 13, fontWeight: '700', color: '#555E61', fontFamily: SERIF },
  answerLetterTextSelected: { color: GREEN },
  answerText: { flex: 1, fontSize: 14, lineHeight: 20, color: '#555E61', fontFamily: SERIF },
  answerTextSelected: { color: '#FDFBF7', fontWeight: '600' },
  ...
  primaryBtnText: { fontSize: 12, fontWeight: '700', color: '#FDFBF7', letterSpacing: 0.8, fontFamily: SERIF },
  ...
  scoreRingValue: { fontSize: 34, fontWeight: '800', fontFamily: SERIF },
  resultsHeadline: { fontSize: 18, fontWeight: '700', color: '#2D3436', fontFamily: SERIF },
  resultsMeta: { fontSize: 13, color: '#8A8478', marginTop: 4, fontFamily: SERIF },

  reviewQuestion: { fontSize: 13, fontWeight: '700', color: '#2D3436', lineHeight: 19, fontFamily: SERIF },
  reviewRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 },
  reviewText: { fontSize: 12, fontWeight: '600', flexShrink: 1, lineHeight: 17, fontFamily: SERIF },
  reviewExplanation: { fontSize: 12, color: '#555E61', lineHeight: 18, marginTop: 10, fontFamily: SERIF },
  ...
  emptyTitle: { fontSize: 16, fontWeight: '700', color: '#2D3436', marginTop: 2, fontFamily: SERIF },
