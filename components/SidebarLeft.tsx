    ...
    <>
      ...
      <aside className="sidebar-desktop w-[260px] shrink-0 h-screen flex flex-col px-6 py-8" style={{ backgroundColor: "#FDFBF7" }}>
        ...
        <div className="flex items-center gap-3 mb-10 px-2">
          ...
          <img src="/landing/logo.png" alt="Aether" className="w-9 h-9 rounded-xl object-cover shrink-0 shadow-sm ring-1 ring-[#EFEBE5]" />
          <span className="text-2xl font-bold tracking-tight text-[#2D3436]">Aether</span>
        </div>
        ...
        <div className="p-6 mt-auto relative">
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-[24px] bg-white border border-[#EFEBE5] cursor-pointer hover:border-[#DDE7DB] transition-colors"
            style={{ boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}
          >
            {user?.user_metadata?.avatar_url ? (
              <img src={user.user_metadata.avatar_url} alt="" className="w-11 h-11 rounded-full object-cover shrink-0" />
            ) : (
              <div className="w-11 h-11 rounded-full flex items-center justify-center text-white font-bold shrink-0" style={{ backgroundColor: "#6B8E61" }}>
