...
**Roadmaps.** Tell Aether what you want to learn, it will create a roadmap of 4-6 modules with actual lessons, learning objectives, key concepts and time estimates. As you complete the modules, they will unlock to show you the next one.
...
| **Database & Auth** | Supabase (Postgres, Google OAuth, storage, RLS) |
