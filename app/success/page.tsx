...
function SuccessContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-deep-onyx px-6">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-4xl font-black text-white mb-4 tracking-tight">You&apos;re In!</h1>
